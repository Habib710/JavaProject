    ...
    for (i = 0; i <= 7; i++) {
      ...
      if ((icon1 == icon2) && (icon2 == icon3) && (icon1 != null)) {
        if (icon1 == ic1) {
          ...
          JOptionPane.showMessageDialog(TTT1.this, "! WOW ,YOU won !!! click reset");
          break;
        } else if (icon1 == ic2) {
          b[(a[i][1] - 1)].setIcon(ic22);
          b[(a[i][2] - 1)].setIcon(ic22);
          b[(a[i][3] - 1)].setIcon(ic22);
          JOptionPane.showMessageDialog(TTT1.this, " Your Oponent won ! click reset");
          break;
        }
      }
    }
